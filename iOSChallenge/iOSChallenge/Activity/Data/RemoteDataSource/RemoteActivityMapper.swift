...
enum RemoteActivityMapper {
    static func map(_ item: RemoteActivityContainer) -> ActivityContainer {
        .init(
            id: item.id,
            state: item.state,
...
private extension RemoteActivityContainer.Activity {
    var presentable: ActivityContainer.Activity {
        .init(screens: screens.map({ $0.presentable }))
    }
}

private extension RemoteActivityContainer.Activity.Screen {
...
private extension RemoteActivityContainer.Activity.Screen.Answer {
...
private extension RemoteActivityContainer.Activity.Screen.Choice {
